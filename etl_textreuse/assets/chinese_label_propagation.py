...
#%%
@asset(deps=[defrag_textreuses],description="The adjacency list of defragmented textreuses")
def adjacency_list() -> None:
    spark = get_spark_session(project_root,application_name="defrag adjaceny list")
...
@asset(deps=[adjacency_list],description="Chinese Label Propagation clusters")

def clusters() -> Output[None]:
  spark = get_spark_session(project_root,application_name="chinese label propagation")
  #%%
