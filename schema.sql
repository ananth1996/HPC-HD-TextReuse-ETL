...
CREATE TABLE `estc_core` (
  ...
  `width.original` bit(1) DEFAULT NULL,
  `height.original` double DEFAULT NULL,
  `obl.original` bit(1) DEFAULT NULL,
  ...
  `uncertain` bit(1) DEFAULT NULL,
  `circa` bit(1) DEFAULT NULL,
  `range` bit(1) DEFAULT NULL,
  `org_500_a` varchar(1082) DEFAULT NULL,
  `total_price` double DEFAULT NULL,
  `tried_to_parse` bit(1) DEFAULT NULL,
  `freq` varchar(18) DEFAULT NULL,
  `annual` double DEFAULT NULL,
  `is_periodical` bit(1) DEFAULT NULL,
  ...
  `false_imprint` bit(1) DEFAULT NULL,
  `org_260_a` varchar(246) DEFAULT NULL,
  `org_260_a_square_brackets` bit(1) DEFAULT NULL,
  ...
  `singlevol` bit(1) DEFAULT NULL,
  `multivol` bit(1) DEFAULT NULL,
  `issue` bit(1) DEFAULT NULL,
  `document.items` double DEFAULT NULL,
  `paper` double DEFAULT NULL,
  `document_type` varchar(10) DEFAULT NULL
) ENGINE=Aria DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci PAGE_CHECKSUM=0 TRANSACTIONAL=0;
