...
CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`textreuse_ids` (
    `trs_id` int(11) unsigned NOT NULL,
    `text_name` varchar(100),
    `manifestation_id` varchar(38),
    `structure_name` varchar(69)
)ENGINE=Columnstore DEFAULT CHARSET=utf8mb3;

CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`manifestation_ids`(
    `manifestation_id_i` int(11) unsigned NOT NULL,
    `manifestation_id` varchar(38)
) ENGINE=Columnstore DEFAULT CHARSET=utf8mb3;

CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`edition_ids`(
    `edition_id_i` int(11) unsigned NOT NULL,
    `edition_id` varchar(38)
) ENGINE=Columnstore DEFAULT CHARSET=utf8mb3;

CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`work_ids`(
    `work_id_i` int(11) unsigned NOT NULL,
    `work_id` text(2858)
) ENGINE=Columnstore DEFAULT CHARSET=utf8mb3;

CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`actor_ids`(
    `actor_id_i` int(11) unsigned NOT NULL,
    `actor_id` varchar(95),
    `name_unified` text
) ENGINE=Columnstore DEFAULT CHARSET=utf8mb3;

CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`textreuse_work_mapping`(
    `trs_id` int(11) unsigned NOT NULL,
    `work_id_i` int(11) unsigned NOT NULL
) ENGINE=Columnstore DEFAULT CHARSET=utf8mb3;

CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`textreuse_edition_mapping`(
    `trs_id` int(11) unsigned NOT NULL,
    `edition_id_i` int(11) unsigned NOT NULL
) ENGINE=Columnstore DEFAULT CHARSET=utf8mb3;

CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`work_mapping`(
    `manifestation_id_i` int(11) unsigned NOT NULL,
    `work_id_i` int(11) unsigned NOT NULL
) ENGINE=Columnstore DEFAULT CHARSET=utf8mb3;

CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`edition_mapping`(
    `manifestation_id_i` int(11) unsigned NOT NULL,
    `edition_id_i` int(11) unsigned NOT NULL
) ENGINE=Columnstore DEFAULT CHARSET=utf8mb3;

CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`edition_publication_date` (
    `edition_id_i` int(11) unsigned NOT NULL,
    `publication_date` date DEFAULT NULL
)ENGINE=Columnstore DEFAULT CHARSET=utf8mb3;

CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`work_earliest_publication_date` (
    `work_id_i` int(11) unsigned NOT NULL,
    `publication_date` date DEFAULT NULL
)ENGINE=Columnstore DEFAULT CHARSET=utf8mb3;

CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`textreuse_earliest_publication_date` (
    `trs_id` int(11) unsigned NOT NULL,
    `publication_date` date DEFAULT NULL
)ENGINE=Columnstore DEFAULT CHARSET=utf8mb3;

CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`edition_authors` (
    `edition_id_i` int(11) unsigned NOT NULL,
    `actor_id_i` int(11) unsigned DEFAULT NULL
)ENGINE=Columnstore DEFAULT CHARSET=utf8mb3;

CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`textreuse_source_lengths` (
    `trs_id` int(11) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`ecco_core` (
...
CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`eebo_core` (
...
CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`estc_actors` (
...
CREATE TABLE IF NOT EXISTS `newspapers_core` (
...
CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`defrag_pieces` (
...
CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`defrag_textreuses` (
...
CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`clustered_defrag_pieces` (
    `piece_id` bigint(20) unsigned NOT NULL,
    `cluster_id` int(11) unsigned NOT NULL
)ENGINE=Columnstore DEFAULT CHARSET=utf8mb3;

CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`earliest_textreuse_by_cluster` (
    `cluster_id` int(11) unsigned NOT NULL,
    `trs_id` int(11) unsigned NOT NULL
)ENGINE=Columnstore DEFAULT CHARSET=utf8mb3;

CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`earliest_work_and_pieces_by_cluster` (
    `cluster_id` int(11) unsigned NOT NULL,
    `work_id_i` int(11) unsigned NOT NULL,
    `piece_id` bigint(20) unsigned NOT NULL
)ENGINE=Columnstore DEFAULT CHARSET=utf8mb3;

CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`reception_edges_denorm` (
...
CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`source_piece_statistics_denorm` (
    `piece_id` bigint(20) unsigned NOT NULL,
    `cluster_id` int(11) unsigned NOT NULL,
    `trs_id` int(11) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`coverages` (
...
CREATE TABLE IF NOT EXISTS `hpc-hd-newspapers-columnstore`.`non_source_pieces` (
    `cluster_id` int(11) unsigned NOT NULL,
    `piece_id` bigint(20) unsigned NOT NULL
)ENGINE=Columnstore DEFAULT CHARSET=utf8mb3;
